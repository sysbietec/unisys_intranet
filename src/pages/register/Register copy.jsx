...
const Register = () => {
    ...
    const [email, setEmailState] = useState('eu@teste.com');
    const [password, setPasswordState ] = useState('12341234');
    const [confirmPassword, setConfirmPassword] = useState('12341234');
